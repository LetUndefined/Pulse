        ...
        <div className="fixed top-[57px] left-0 right-0 z-99 bg-bg2 border-b border-border flex flex-col px-5 py-6 gap-5 md:hidden">
          {navItems.map((item) => (
            <a
              ...
              className="text-text font-grotesk font-bold text-[16px] no-underline"
          ...
          <a
            href="#partners"
            className="font-bold font-grotesk bg-neon text-bg rounded-xl px-4 py-2.5 text-center no-underline text-[15px]"
            onClick={() => setOpen(false)}
          >
            Become a partner
          </a>
