...
function Step({ number, title, description, accent }: StepProps) {
  return (
    <div className="bg-bg border border-border rounded-[20px] p-7 relative">
      <div className="font-grotesk text-[48px] font-bold leading-none mb-4" style={{ color: accent, opacity: 0.2 }}>
        {number}
      </div>
